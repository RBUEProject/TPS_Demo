...
protected:
	...
	UFUNCTION()//Timer绑定的函数需要UFUNCTION
	void AutoFireReset();
	...
	void PickUpAmmo(class AAmmo* Ammo);//捡子弹
...
private:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	UParticleSystem* BeamParticles;//烟效
	...
	float AutomaticFireRate;//自动射击速度
	...
	class Aitem* TraceHitItemLastFrame;//最后一帧触碰到的item
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Items, meta = (AllowPrivateAccess = "true"))
	TMap<EAmmoType, int32> AmmoMap;//<枪械,弹药数>

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Items, meta = (AllowPrivateAccess = "true"))
	int32 Starting9mmAmmo;//9mm的起始弹药量
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, meta = (AllowPrivateAccess = "true"))
	TArray<FInterpLocation> InterpLocations;//存放上面的location
